                        ...
                        items-center justify-center p-20 md:p-44 h-screen">
                            ...
                            <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                                ...
                                <p className='text-lg text-center md:text-left'>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam, culpa. Eos accusamus incidunt autem excepturi. Explicabo magnam ipsum a soluta! Omnis doloremque est molestiae repellendus unde beatae aut reiciendis ea.
                                </p>
                            </div>
                        </div>
                ))
