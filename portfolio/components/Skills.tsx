...
export default function Skills({}: Props) {
  return (
    <motion.div className='flex relative flex-col text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-screen justify-center xl:space-y-0 mx-auto items-center'>
        ...
        <h3 className='absolute top-36 uppercase tracking-[3px] text-gray-500 text-sm'> hover over</h3>
        <div className='grid xl:grid-cols-8 md:grid-cols-4 grid-cols-3 gap-5'>
            <Skill />
            <Skill />
            <Skill />
            <Skill />
